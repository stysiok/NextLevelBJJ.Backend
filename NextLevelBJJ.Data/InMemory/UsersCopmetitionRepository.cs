...
{
    public class UserCompetitionsRepository : IUserCompetitionsRepository
    {
        private List<UserCompetitions> userCompetitions = new List<UserCompetitions>()
        {
            new UserCompetitions()
            {
